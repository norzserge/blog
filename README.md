⚠️ На текущий момент функционал добавления, удаления и редактирования записей не работает. Возникли проблемы с БД, на которую увы у меня пока нет времени, да и нужно ли с этим разбираться...?)
